...
$resp_balance = $resp_obj->result;
// Format balance
$dai_balance = (int)$resp_balance / 1000000000000000000;
...
$GET_ERC20TX_OPTS = "?module=account&action=tokentx&contractaddress=".$DAI_CONTRACT_ADDRESS."&address=".$TM_SAFE_ADDRESS."&startblock=0&endblock=".$latest_block."&page=1&offset=5&sort=dec&apikey=".$POLYGONSCAN_API_TOKEN;
